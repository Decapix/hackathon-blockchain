...
function getSolProviderHandlers({
  ...
  return {
    ...
    signTransaction: async (req) => {
      const [{
        PublicKey
      }, accounts] = await Promise.all([import("./index.browser.esm-EKODZMJP.js"), getAccounts(connector)]);
