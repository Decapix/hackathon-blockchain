...
} from "./chunk-VTUENOMV.js";
import {
  createChainSwitchMiddleware,
  createEthMiddleware,
  createJsonRpcClient,
  recoverAddress
} from "./chunk-AD23FB72.js";
import "./chunk-2ICFHSBY.js";
import "./chunk-MIYUJY7P.js";
import "./chunk-F53XTNZ4.js";
import "./chunk-OKU7VVAM.js";
import {
  BaseProvider
} from "./chunk-GHOXYBDX.js";
import "./chunk-NSJ32LYK.js";
import {
  ADAPTER_CATEGORY,
  ADAPTER_EVENTS,
  ADAPTER_NAMESPACES,
...
function base(ALPHABET2) {
  ...
  function encode5(source) {
    ...
    while (pbegin !== pend) {
      ...
      let i4 = 0;
      for (let it1 = size - 1; (carry !== 0 || i4 < length2) && it1 !== -1; it1--, i4++) {
        carry += 256 * b58[it1] >>> 0;
        b58[it1] = carry % BASE >>> 0;
        carry = carry / BASE >>> 0;
      }
  ...
  function decodeUnsafe(source) {
    ...
    while (psz < source.length) {
      ...
      let i4 = 0;
      for (let it3 = size - 1; (carry !== 0 || i4 < length2) && it3 !== -1; it3--, i4++) {
        carry += BASE * b256[it3] >>> 0;
        b256[it3] = carry % 256 >>> 0;
        carry = carry / 256 >>> 0;
      }
...
var import_bs585 = __toESM(require_bs58());
...
function getSolProviderHandlers({
  ...
  return {
    ...
    signTransaction: async (req) => {
      const [{
        PublicKey
      }, accounts] = await Promise.all([import("./index.browser.esm-TTAZ66A6.js"), getAccounts(connector)]);
