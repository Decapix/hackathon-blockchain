  ...
  async init() {
    ...
    const initPromises = Object.keys(this.walletAdapters).map(async (adapterName) => {
      ...
      if (adapterName === WALLET_ADAPTERS.AUTH) {
        ...
        this.coreOptions.uiConfig = (0, import_deepmerge.default)(cloneDeep(whitelabel || {}), this.coreOptions.uiConfig || {});
  ...
  (0, import_react25.useEffect)(() => {
    ...
    stateListener.on("STATE_UPDATED", (newModalState) => {
      ...
      setModalState((prevState) => {
        const mergedState = cloneDeep((0, import_deepmerge2.default)(prevState, newModalState));
        return mergedState;
      });
    });
  }, [stateListener]);
  ...
  constructor(_uiConfig) {
    ...
    _defineProperty(this, "initModal", async () => {
      ...
      if (useLang === LANGUAGES.de) {
        import("./german.json-F3NHG6EQ.js").then((messages) => {
        ...
        import("./japanese.json-J2WFKGJT.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
        ...
        import("./korean.json-QZHNMTBB.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
        ...
        import("./mandarin.json-IGNCPVX7.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
        ...
        import("./spanish.json-RAXJIDSL.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
        ...
        import("./french.json-JZVPJXEK.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
        ...
        import("./portuguese.json-G2DTUTEE.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
        ...
        import("./dutch.json-IYS7HC3V.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
        ...
        import("./turkish.json-YBS6CQWX.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
        ...
        import("./english.json-MA6GCT6H.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
...
var Web3Auth = class extends Web3AuthNoModal {
  ...
  async initModal(params) {
    ...
    this.options.uiConfig = (0, import_deepmerge3.default)(cloneDeep(whitelabel || {}), this.options.uiConfig || {});
    ...
    if (smsOtpEnabled !== void 0) {
      ...
      params.modalConfig = (0, import_deepmerge3.default)(adapterConfig, cloneDeep(params.modalConfig));
    }
