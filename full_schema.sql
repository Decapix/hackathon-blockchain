...
--
-- Name: ok test; Type: TABLE; Schema: public; Owner: supabase_admin
--

CREATE TABLE public."ok test" (
    id bigint NOT NULL,
...
ALTER TABLE public."ok test" OWNER TO supabase_admin;

--
-- Name: ok test_id_seq; Type: SEQUENCE; Schema: public; Owner: supabase_admin
--

ALTER TABLE public."ok test" ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."ok test_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ok test ok test_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public."ok test"
    ADD CONSTRAINT "ok test_pkey" PRIMARY KEY (id);
...
--
-- Name: ok test; Type: ROW SECURITY; Schema: public; Owner: supabase_admin
--

ALTER TABLE public."ok test" ENABLE ROW LEVEL SECURITY;
...
--
-- Name: TABLE "ok test"; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE public."ok test" TO postgres;
GRANT ALL ON TABLE public."ok test" TO anon;
GRANT ALL ON TABLE public."ok test" TO authenticated;
GRANT ALL ON TABLE public."ok test" TO service_role;


--
-- Name: SEQUENCE "ok test_id_seq"; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON SEQUENCE public."ok test_id_seq" TO postgres;
GRANT ALL ON SEQUENCE public."ok test_id_seq" TO anon;
GRANT ALL ON SEQUENCE public."ok test_id_seq" TO authenticated;
GRANT ALL ON SEQUENCE public."ok test_id_seq" TO service_role;
